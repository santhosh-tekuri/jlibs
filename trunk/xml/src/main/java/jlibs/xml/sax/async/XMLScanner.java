...
public class XMLScanner extends jlibs.nbp.NBParser{
    ...
    public static final int RULE_ENTITY_DECL = 38;
    ...
    public static final int RULE_ENTITY_DEF = 39;
    ...
    private int children(int ch) throws Exception{
        switch(stateStack.peek()){
            ...
            case 6:
                ...
                expected(ch, "[(] OR <NAME_START> OR <WS>");
            case 7:
                if(WS(ch)){
                    return 7;
                }
    ...
    private int element_decl(int ch) throws Exception{
        switch(stateStack.peek()){
            ...
            case 13:
                ...
                expected(ch, "[E] OR [A] OR [(] OR <WS> OR <NAME_START>");
            case 18:
                if(ch=='M'){
                    return 19;
                }
                if(ch=='>'){
                    push(RULE_CHILDREN, 25, 10);
                    pop();
                    return 26;
                }
                if(WS(ch)){
                ...
                expected(ch, "[M] OR [>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 19:
                if(ch=='P'){
                    return 20;
                }
                ...
                expected(ch, "[P] OR [>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 20:
                if(ch=='T'){
                    return 21;
                }
                ...
                expected(ch, "[T] OR [>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 21:
                if(ch=='Y'){
                    return 22;
                }
                ...
                expected(ch, "[Y] OR [>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 22:
                if(ch=='>'){
                    return 26;
                }
                ...
                expected(ch, "[>] OR <WS> OR <NAME_PART>");
            case 23:
                if(ch=='>'){
                    push(RULE_CHILDREN, 25, 10);
                    pop();
                ...
                expected(ch, "[>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 24:
                if(ch=='>'){
                    push(RULE_CHILDREN, 25, 10);
                    pop();
            ...
            case 30:
                ...
                expected(ch, "[N] OR [>] OR <WS> OR [?+*] OR <NAME_PART>");
            case 31:
                if(ch=='Y'){
                    return 32;
                }
