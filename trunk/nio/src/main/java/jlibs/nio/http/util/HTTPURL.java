...
public class HTTPURL{
    ...
    public HTTPURL(String url) throws IllegalArgumentException{
        ...
        if(colon==-1)
            throw new IllegalArgumentException("protocol missing in url");
        ...
        if(colon==-1)
            ...
            try{
                ...
                throw new IllegalArgumentException("bad port in url: "+host.substring(colon+1));
            }
    ...
    public ClientEndpoint createClientEndpoint() throws GeneralSecurityException, SSLException{
        ClientEndpoint clientEndpoint = new ClientEndpoint(host, port);
        if(secured)
